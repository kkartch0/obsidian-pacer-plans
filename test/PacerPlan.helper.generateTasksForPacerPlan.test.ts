...
describe("PacerPlan", () => {
    describe("generateTasksForPacerPlan", () => {
        it("scenario 1: should generate tasks for the PacerPlan", () => {
            ...
            const result = generateTasksForPacerPlan(plan, plan.startNumber, { today: () => new Date(2024, 7, 19) });
        ...
        it("scenario 2: should generate tasks for the PacerPlan", () => {
            ...
            const result = generateTasksForPacerPlan(plan, plan.startNumber, { today: () => new Date(2024, 8, 2) });
        ...
        it("should return an empty array if start date is after end date", () => {
            ...
            const result = generateTasksForPacerPlan(plan, plan.startNumber, { today: () => new Date(2022, 1, 7) });
